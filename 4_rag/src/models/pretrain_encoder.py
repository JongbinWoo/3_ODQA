...
from src.models.modules.encoder import BertEncoder
...
class Retriever(LightningModule):
    def __init__(
        ...
        **kwargs
        ...
        self.encoder_q = BertEncoder.from_pretrained(MODEL_NAME)
        self.encoder_k = BertEncoder.from_pretrained(MODEL_NAME)

        for param_q, param_k in zip(self.encoder_q.parameters(), self.encoder_k.parameters()):
            param_k.data.copy_(param_q.data)
            param_k.requires_grad = False
        
        self.register_buffer('queue', torch.randn(768, num_negatives))

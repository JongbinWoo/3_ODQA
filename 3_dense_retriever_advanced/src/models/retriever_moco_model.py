...
class Retriever(LightningModule):
    def __init__(
        ...
        num_negatives: int = 187200+14080,
        ...
        **kwargs
        ...
        self.register_buffer('queue', torch.zeros(256, num_negatives))
    ...
    def _load_pretrained_model(self):
        encoder = DualEncoder.load_from_checkpoint('/opt/ml/code/pytorch_lightning_examples/3_RETRIEVER/logs/runs/2021-05-20/07-26-35/checkpoints/epoch=08.ckpt')
    ...
    def training_step(self, batch, batch_idx):
        ...
        acc5, acc10 = precision_at_k(logits, labels, top_k=(5, 10))

        log = {'train_loss': loss, 'train_acc5': acc5, 'train_acc10': acc10}
        self.log_dict(log)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        acc5, acc10 = precision_at_k(output, target, top_k=(5, 10))

        results = {'val_loss': loss, 'val_acc5': acc5, 'val_acc10': acc10}
        return results
    ...
    def validation_epoch_end(self, outputs):
        ...
        log = {'val_loss': val_loss, 'val_acc5': val_acc5, 'val_acc10': val_acc10}
        self.log_dict(log)

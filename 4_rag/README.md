# TO-DO
- batch 만들때 같은 passage를 갖는 질문은 하나만 나오도록.
- BM 25이용해서 hard negative
-> sampler를 잘 만들면 된다.
+ datasets에 sort이용하면 좋을듯.
-> dataset.sort('id')를 하면 바로 위 아래는 같은 글의 다른 문단인 경우가 많다. sorted_dataset['train']['title']로 확인
-> 같은 글의 다른 단락을 negative로 하면 좋을듯?
<div align="center">
